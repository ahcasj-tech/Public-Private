...
const artwork=(filename)=>`${import.meta.env.BASE_URL}assets/works/${filename}`;
const asset=(group,index,label)=>({src:artwork(`${group}-${index}.webp`),label});
export const works = [
  {
    id:'flow',number:'01',title:'FLOW',subtitle:'流动的边界',category:'陶瓷壁砖设计',themes:['形态','色彩','秩序'],
    image:artwork('flow-3.webp'),alt:'以自然曲线和多色块拼接组成的九宫格陶瓷壁砖设计',
  ...
  },
  {
    ...
    image:artwork('fruit-1.webp'),alt:'FRUIT DOTS 系列中以彩色半调网点构成苹果的白底海报',
    intro:'用点的密度，\n写下水果的形状。',
  ...
  },
  {
    ...
    image:artwork('photo-1.webp'),alt:'浅色天空下有红框窗户和岁月痕迹的老楼立面',
    intro:'建筑、枝叶与天空，\n日常里的停顿。',
  ...
  },
  {
    ...
    image:artwork('applications-1.webp'),alt:'FRUIT DOTS 水果图形应用在手提袋、包装、贴纸与纸品上的设计效果图',
    intro:'让图形进入日常，\n成为可以携带的色彩。',
  ...
  },
  {
    ...
    image:artwork('painting-4.webp'),alt:'以绿色层次和可见笔触描绘的田野、山坡与树木',
    intro:'以色块和笔触，\n记录不同风景的温度。',
